...
class MVSCGOPDataset(Dataset):
    def __init__(self, root, split='train', num_views=4, num_frames=4, crop_size=256):
        ...
    def __len__(self):
        ...
...
def get_loader(args, config):
    ...
    elif args.trainset == 'MVSC':
        train_dataset = MVSCGOPDataset(...)
        test_dataset = MVSCGOPDataset(...)
    else:
