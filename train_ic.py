...
def parse_args():
    ...
    parser.add_argument("--individual-depths", type=str, default="2,2,2")
    parser.add_argument("--common-depths", type=str, default="2,2,2")
    parser.add_argument("--common-heads", type=str, default="8,8,8")
...
class ModernMVSCNet(nn.Module):
    def __init__(self, args):
        ...
        # IMPORTANT: JSCC decoder must reconstruct back to the common decoder input width 320
        self.jscc_decoder = dec_mod.MVSC_JSCC_Decoder(
            latent_dim=self.latent_dim,
            embed_dim=320,
            compressed_num_views=max(1, self.num_views // 2),
